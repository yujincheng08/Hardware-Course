...
#
# Generated by Vivado on Fri Dec 23 13:59:17 +0800 2016
...
# Script info
echo -e "vram.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vram xil_defaultlib.vram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim vram -key {Behavioral:sim_1:Functional:vram} -tclbatch cmd.tcl -log simulate.log
}
