...
#
# Generated by Vivado on Mon Jan 02 11:28:09 +0800 2017
# IP Build 1681267 on Mon Oct 10 21:28:31 MDT 2016 
#
# usage: mouse.sh [-help]
# usage: mouse.sh [-lib_map_path]
# usage: mouse.sh [-noclean_files]
# usage: mouse.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "mouse.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mouse xil_defaultlib.mouse xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim mouse -key {Behavioral:sim_1:Functional:mouse} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./mouse.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mouse.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./mouse.sh -help\" for more information)\n"
    exit 1
  fi
