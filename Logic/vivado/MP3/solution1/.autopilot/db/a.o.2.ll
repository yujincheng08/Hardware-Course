; ModuleID = 'F:/vivado/MP3/solution1/.autopilot/db/a.o.2.bc'
...
define i32 @add(i32 %a, i32 %b) nounwind readnone {
  ...
  call void @llvm.dbg.value(metadata !{i32 %a}, i64 0, metadata !35), !dbg !36 ; [debug line = 1:13] [debug variable = a]
  call void @llvm.dbg.value(metadata !{i32 %b}, i64 0, metadata !37), !dbg !38 ; [debug line = 1:20] [debug variable = b]
  %tmp = add nsw i32 %a, %b, !dbg !39             ; [#uses=1 type=i32] [debug line = 3:2]
  ret i32 %tmp, !dbg !39                          ; [debug line = 3:2]
}
...
!36 = metadata !{i32 1, i32 13, metadata !5, null}
!37 = metadata !{i32 786689, metadata !5, metadata !"b", metadata !6, i32 33554433, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!38 = metadata !{i32 1, i32 20, metadata !5, null}
!39 = metadata !{i32 3, i32 2, metadata !40, null}
!40 = metadata !{i32 786443, metadata !5, i32 2, i32 1, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
