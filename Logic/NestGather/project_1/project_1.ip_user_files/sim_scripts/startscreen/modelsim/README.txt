...
#
# Generated by export_simulation on Fri Jan 06 17:16:42 +0800 2017
#
################################################################################
...
switch to the './startscreen.sh' script.

./startscreen.sh -reset_run
...
./startscreen.sh -noclean_files

For more information on the script, please type './startscreen.sh -help'.
