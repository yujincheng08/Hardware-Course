...
#
# Generated by Vivado on Sat Dec 30 19:09:02 CST 2017
...
# Script info
echo -e "RAM_B.sh - Script generated by export_simulation (Vivado v2017.3 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_0 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_B xil_defaultlib.RAM_B xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/lovesy/Application/Xilinx/Vivado/2017.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
